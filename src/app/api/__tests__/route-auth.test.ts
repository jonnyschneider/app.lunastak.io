...
const KNOWN_UNGUARDED: string[] = [
  ...
  'src/app/api/conversation/[id]/messages/route.ts',
  ...
  'src/app/api/extraction-status/[conversationId]/route.ts',
  ...
  'src/app/api/project/[id]/generation-status/route.ts',
  ...
  'src/app/api/project/[id]/strategy/route.ts',
  'src/app/api/project/[id]/synthesize/route.ts',
