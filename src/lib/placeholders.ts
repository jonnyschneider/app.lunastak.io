...
export function generatePlaceholderPrinciples(): Principle[] {
  return [
    {
      id: 'prin-1',
      priority: 'Long-term customer value',
      deprioritized: 'short-term gains',
      context: 'Every decision prioritizes building lasting relationships.',
    },
    {
      id: 'prin-2',
      priority: 'Data-driven decisions',
      deprioritized: 'gut instinct',
      context: 'Base strategic choices on quantitative evidence and validated learning.',
    },
    {
      id: 'prin-3',
      priority: 'Speed of learning',
      deprioritized: 'perfect execution',
      context: 'Test assumptions quickly, learn fast, and adapt based on feedback.',
    },
    {
      id: 'prin-4',
      priority: 'Quality',
      deprioritized: 'speed',
      context: 'Build sustainable solutions that scale rather than quick fixes.',
    },
    {
      id: 'prin-5',
      priority: 'Transparency',
      deprioritized: 'information control',
      context: 'Share information openly with stakeholders to build trust and alignment.',
    },
    {
      id: 'prin-6',
      priority: 'Profitability',
      deprioritized: 'growth at any cost',
      context: 'Focus on sustainable, repeatable growth models.',
    },
    {
      id: 'prin-7',
      priority: 'Team autonomy',
      deprioritized: 'centralized control',
      context: 'Give teams ownership to drive innovation and accountability.',
    },
    {
      id: 'prin-8',
      priority: 'Continuous improvement',
      deprioritized: 'status quo',
      context: 'Regularly review and refine processes, products, and strategies.',
    },
  ];
}
