...
export const LLM_POLICY: Record<LlmContext, Policy> = {
  ...
  full_synthesis:                   { maxTokens: 4000, guidance: 'question-gap', system: FULL_SYNTHESIS_SYSTEM, cacheable: true },  // 1633 tok, measured
  incremental_synthesis:            { maxTokens: 4000, guidance: 'question-gap', system: INCREMENTAL_SYNTHESIS_SYSTEM, cacheable: true },  // 1538 tok, measured
