...
export default function StrategyDisplay({ strategy, conversationId, traceId, projectId, onUpdate, readOnly = false, onDraftOpportunities }: StrategyDisplayProps) {
                    ...
                    <FlipCard
                      front={
                        <div className="bg-ds-teal rounded-xl p-6 shadow-sm">
                          ...
                          {/* Objective statement */}
                          {objective.objective && (
                            <p className="text-[13px] font-normal text-white/90 leading-relaxed">
                              {objective.objective}
                            </p>
                          )}
                          {/* Supporting metrics */}
