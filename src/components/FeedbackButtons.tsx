  ...
  return (
    <div className="flex gap-4 justify-center py-6">
      <button
        ...
        className="flex items-center gap-2 px-6 py-3 border border-border rounded-lg hover:bg-muted disabled:opacity-50"
      >
        <span className="text-2xl">👍</span>
        <span className="text-foreground">This is helpful</span>
      </button>
      <button
      ...
      >
        <span className="text-2xl">👎</span>
        <span className="text-foreground">Not quite right</span>
      </button>
    </div>
  );
}
