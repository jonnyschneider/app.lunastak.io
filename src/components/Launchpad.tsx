      ...
      <div className="text-center space-y-5">
        ...
        <div className="space-y-1">
          <p className="text-sm text-muted-foreground">
            Because every company has a <span className="italic font-[family-name:var(--font-ibm-plex-mono)] bg-[#c74188] text-white/90 px-1.5 py-0.5 rounded-sm inline-block -rotate-2">story</span>.
          </p>
          <p className="text-sm text-muted-foreground">
