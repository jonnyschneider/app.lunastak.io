...
**Lunastak** ([[app.lunastak.io]{.underline}](http://app.lunastak.io)) is an AI-powered strategic planning tool that aims to replace human strategy consultants by extracting strategic insight from unstructured conversations and generating expert-quality recommendations.

# 2. The Core Uncertainty
...
**Why five activities?** The original conception (A1-A3) proved insufficient as development revealed that A4 (Interaction Design) directly gates whether A1 can be tested---if users can\'t engage, the core hypothesis is untestable. A5 (Performance) affects whether users complete sessions---slow responses cause abandonment before data is collected. These are not \"nice to have\" UX polish---they are research prerequisites.
...
# 4. Systematic Experimentation
  ...
  **Experiment**                 **Question**                                              **Approach**                                                      **Status**
  ------------------------------ --------------------------------------------------------- ----------------------------------------------------------------- ----------------
  E0: Baseline                   Can we measure strategic output quality?                  Adaptive conversation, prescriptive extraction, quality ratings   ✅ Validated

  E1: Emergent Extraction        Does freeform extraction beat prescriptive fields?        A/B test via Statsig; emergent themes vs fixed fields             ✅ Pass

  **E2: Dimensional Coverage**   What coverage do we achieve without guidance?             Post-hoc mapping of themes to 11 strategic dimensions             ✅ \~75%

  **E3: Dimension-Guided**       Does guiding questions improve coverage?                  Parallel A/B with E2; compare guided vs emergent                  🟡 In progress

  **E6-E10**                     LLM-as-judge, optimal depth, multi-session accumulation   Planned                                                           ⚪ Planned
  ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## 4.1 Experimentation Infrastructure Evolution
...
# 7. Estimated Eligible Expenditure
...
# 9. Alignment with R&DTI Requirements

## 9.1 Four \"Ingredients\" Satisfied
...
## 9.2 Software Sector Guidance Compliance
